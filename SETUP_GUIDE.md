...
### 必須項目
1. バナー画像（添付ファイル）
   - jpg, jpeg, png, gif形式に対応
   - 1メッセージにつき1枚の画像を添付

2. LP URL
   - 完全なURL形式（http:// または https:// から始まる）
   - メッセージ内の最初のURLが使用されます
...
### 注意事項
- 全ての情報を1つのメッセージにまとめて投稿
- 画像は必ずファイル添付として投稿（URLでの投稿は非対応）
- 必須項目が不足している場合は記録されません
- メモは省略可能です
